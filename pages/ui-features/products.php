      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <button class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm" type="submit"><i class="fa fa-plus fa-lg text-white-50 mx-2"></i> Add Products </button>
          </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                  ...
                                  <table class="table table-bordered dataTable no-footer">
                                   ...
                                   <tr>
                                    <td>AFL Uniform</td>
                                    <td> <img src="../../photo/img 1.jpg" alt=""> </td>
                                    <td>ES:1251</td>
                                    <td>0</td>
                                    <td>1</td>
